...
//レンダー系のコンポーネントがアタッチされてるGameObjectのみアタッチできる
...
public class sortingLayerDrawerAttribute : PropertyDrawer {
   ...
   public override void OnGUI(Rect position,SerializedProperty property, GUIContent lavel) {
        ...
        selectedIndex = EditorGUI.Popup(position, lavel.text, selectedIndex, list.ToArray());
